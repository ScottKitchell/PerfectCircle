...
############ Configuration ##############
$thumb_square_size      = 90; //Thumbnails will be cropped to 250x250 pixels
$max_image_size         = 900; //Maximum image size (height and width)
$thumb_prefix           = "thumb_"; //Normal thumb Prefix
$destination_folder     = '../users/'.$userID.'/tmp/'; //upload directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
     ...
     if($image_res){
         ...
         $new_file_name = newID(12) . '.' . $image_extension;
